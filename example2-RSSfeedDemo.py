...
class TitleTrigger(WordTrigger):
    ...
    def evaluate(self, newsStoryInstance):
        title = newsStoryInstance.getTitle()
...
class SubjectTrigger(WordTrigger):
    ...
    def evaluate(self, newsStoryInstance):
        subject = newsStoryInstance.getSubject()
...
class SummaryTrigger(WordTrigger):
    ...
    def evaluate(self, newsStoryInstance):
        summary = newsStoryInstance.getSummary()
...
class PhraseTrigger(Trigger):
    ...
    def evaluate(self, newsStoryInstance):
        ...
        return phrase in (title or subject or summary)
