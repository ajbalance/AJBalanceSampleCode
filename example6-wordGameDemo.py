...
def isValidWord(word, hand, wordList):
    ...
    if word not in wordList:
        ...
        for letter in word:
            if updatedhand.get(letter) == None or updatedhand.get(letter) == 0:
                answer = False
                break
            else:
                updatedhand[letter] -= 1
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    totalscore = 0
    remaininghandlength = calculateHandlen(hand)

    # As long as there are still letters left in the hand:
    
    while remaininghandlength > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print '"'+ inputword +'" earned '+ str(getWordScore(inputword,n)) + ' points. Total: ' + str(totalscore) + ' points.'
                print 
                # Update the hand 
...
def playGame(wordList):
    ...
    while True:
        print
        inputword = raw_input('Enter n to deal a new hand, r to replay the last hand, or e to end game: ')
